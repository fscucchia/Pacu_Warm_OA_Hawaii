...
plot1 <- ggplot(ress_filt, aes(delta.rank.x, delta.rank.y, label = name.y, color = include)) +
  ...
  #   segment.color = NA) + # No line segment needed here
  theme_cowplot()+
  annotate("label", label = "Overrepresented in High", x = 2600, y = 500, size = 7, color = "red", label.size = 0.8)+
  annotate("label", label = "Underrepresented in High", x = -2600, y = -500, size = 7, color = "blue", label.size = 0.8)+
  ...
  theme(axis.text = element_text(size = 25),
        axis.title = element_text(size = 35)); plot1
