...
plot1 <- ggplot(ress_filt, aes(delta.rank.x, delta.rank.y, label = name.y)) +
  ...
  scale_size("size") +
  scale_x_continuous(limits = c(-2700, 2700), breaks = seq(-2000, 2000, 1000)) +
  scale_y_continuous(limits = c(-2700, 2700), breaks = seq(-2000, 2000, 1000)) +
  labs(x = "Delta Rank (High v. Control)", y = "Delta Rank (High v. Mid)") +
  geom_vline(xintercept = 0, linetype = "dashed", alpha = 0.75) +
  geom_hline(yintercept = 0, linetype = "dashed", alpha = 0.75) +
  ...
  #   fill = "white", # Background color of the label
  #   segment.color = NA) + # No line segment needed here
  annotate("label", label = "Overrepresented in High", x = 500, y = 2200, size = 4, color = "black")+
  annotate("label", label = "Underrepresented in High", x = -2100, y = -800, size = 4, color = "black")+
  annotate("text", label = paste("Slope:", round(slope, 2)), x = 2300, y = -2300, size = 3, color = "black") +
...
```{r}
# Plot
plot2 <- ggplot(ress_filt, aes(delta.rank.x, delta.rank.y, label = name.y)) +
  geom_point(size = 2, show.legend = FALSE) +
  scale_size("size") +
  scale_x_continuous(limits = c(-2700, 2700), breaks = seq(-2000, 2000, 1000)) +
  scale_y_continuous(limits = c(-2700, 2700), breaks = seq(-2000, 2000, 1000)) +
  ...
  #   fill = "white", # Background color of the label
  #   segment.color = NA) + # No line segment needed here
  annotate("label", label = "Enriched in High", x = 610, y = 2300, size = 4, color = "black")+
  annotate("label", label = "Underrepresented in High", x = -1900, y = -900, size = 4, color = "black")+
  annotate("text", label = paste("Slope:", round(slope, 2)), x = 2300, y = -2300, size = 3, color = "black") +
  theme(axis.text = element_text(size = 50),
        axis.title = element_text(size = 70)) +
  theme_cowplot(); plot2
...
```{r}
# Plot
plot3 <- ggplot(ress_filt, aes(delta.rank.x, delta.rank.y, label = name.y)) +
  geom_point(size = 2, show.legend = FALSE) +
  scale_size("size") +
  scale_x_continuous(limits = c(-2700, 2700), breaks = seq(-2000, 2000, 1000)) +
  scale_y_continuous(limits = c(-2700, 2700), breaks = seq(-2000, 2000, 1000)) +
  ...
  #   fill = "white", # Background color of the label
  #   segment.color = NA) + # No line segment needed here
  annotate("label", label = "Enriched in High + Mid", x = 600, y = 2000, size = 4, color = "black")+
  annotate("label", label = "Underrepresented in High + Mid", x = -1600, y = -2100, size = 4, color = "black")+
  annotate("text", label = paste("Slope:", round(slope, 2)), x = 2300, y = -2300, size = 3, color = "black") +
  theme(axis.text = element_text(size = 50),
        axis.title = element_text(size = 70)) +
  theme_cowplot(); plot3
...
```{r}
# Plot
plot4 <- ggplot(ress_filt, aes(delta.rank.x, delta.rank.y, label = name.y)) +
  geom_point(size = 2, show.legend = FALSE) +
  scale_size("size") +
  scale_x_continuous(limits = c(-2700, 2700), breaks = seq(-2000, 2000, 1000)) +
  scale_y_continuous(limits = c(-2700, 2700), breaks = seq(-2000, 2000, 1000)) +
  ...
  #   fill = "white", # Background color of the label
  #   segment.color = NA) + # No line segment needed here
  annotate("label", label = "Overrepresented in High + Mid", x = 1500, y = 1700, size = 4, color = "black")+
  annotate("label", label = "Underrepresented in High + Mid", x = -1600, y = -1650, size = 4, color = "black")+
  annotate("text", label = paste("Slope:", round(slope, 2)), x = 2300, y = -2300, size = 3, color = "black") +
  theme(axis.text = element_text(size = 50),
        axis.title = element_text(size = 70)) +
  theme_cowplot(); plot4
