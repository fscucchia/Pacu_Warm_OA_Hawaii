...
Plot heatmap and PCA in one figure 
```{r}
heatmap_grob <- heatmap_degs$gtable   # if you assigned pheatmap() to heatmap_degs

combined_plot <- plot_grid(
  heatmap_grob, pca_plot_degs,
  labels = c("A)", "B)"),
  label_size = 16,
  ncol = 2,
  align = "h"); combined_plot

ggsave("../output/DEG/heatmap_PCA_DEGs.png", plot = combined_plot, width = 40, height = 20, units = "cm", dpi = 700)
ggsave("../figures/FIGURE_4.png", plot = combined_plot, width = 40, height = 20, units = "cm", dpi = 700)
```
